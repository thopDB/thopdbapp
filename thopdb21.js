...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">download link</label>
	  <input class="mvd" type="text" value="${url}"/>
	</div>
	<div class="mdui-textfield">
...
<a href="https://upcomingmoviewiki.blogspot.com/p/download.html?id=${url}" target="_blank" rel="nofollow" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
	`;
	$('#content').html(content);
