...
<br>
<footer class="footer mt-auto py-3 text-muted ${UI.footer_style_class}" style="${UI.fixed_footer ?'position: fixed; ': ''}left: 0; bottom: 0; width: 100%; height: 92px; color: white; z-index: 9999;${UI.hide_footer ? ' display:none;': ' display:block;'}"> <div class="container" style="width: auto; padding: 0 10px;"> <p class="float-end"> <a href="#">Back to top</a> </p> <p><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6076330206220198"
     crossorigin="anonymous"></script>
<!-- firstthopdb -->
<ins class="adsbygoogle"
     style="display:block"
...
<script>
  ...
  <div class="btn-group text-center">
      <a href="https://dw.thopdb.com/?id=${url}" type="button" class="btn btn-primary">Download</a>
